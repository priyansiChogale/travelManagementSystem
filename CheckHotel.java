...
public class CheckHotel extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text= new String[]{"JW Marriott Hotel","Mandarin Oriental Hotel","Four Season Hotel","Maddison Hotel","Classic Hotel","The Bay Club Hotel","Breeze Blows Hotel","Quick Stop Hotel","Happy Mornings Hotel","Moss View Hotel"};
        try{
        for(int i=0; i<=9;i++){
    ...
    CheckHotel(){
        ...
        for(int i=0; i<=9; i++){
             img[i] = new ImageIcon("C:\\Users\\Priyansi\\Downloads\\icons-20201117T113155Z-001\\icons\\hotel"+(i+1)+".jpg");
